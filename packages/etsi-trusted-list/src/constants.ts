 ...
 *
 * These are the standard values used by eIDAS national trusted lists (e.g. the
 * ES list). Profiled lists may use their own profile-specific URIs (validated
 * via a caller-supplied {@link ProfileRule}); this library's parser is agnostic
 * to both.
 */
